...
// TODO: ensure correct ordering of events
...
CREATE INDEX IF NOT EXISTS events_pubkey_index ON results (pubkey);
CREATE INDEX IF NOT EXISTS events_processes_at_index ON results (processed_at);
CREATE INDEX IF NOT EXISTS events_created_at_index ON results (created_at);
